...
public class Practica2 {
	...
	public static void main(String[] args) {
		...
		insertar_barco(tablero_relleno, 'L', 1, 5);
		insertar_barco(tablero_relleno, 'B', 3, 3);
	...
	public static void insertar_barco(char[][] tablero, char tipo, int tamano, int cantidad) {

		int barcos_colocados = 0, fila, columna;
		boolean es_horizontal;
	...
	public static void jugar(char[][] tablero_relleno, char[][] tablero_jugador, int intentos) {
		...
		while (intentos > 0 && contar_barcos(tablero_relleno) != 0) {
